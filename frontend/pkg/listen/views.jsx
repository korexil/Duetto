...
function LSChatView({ tab, setTab, idx, setIdx, playing, setPlaying, ncmSong, ncmLyric, ncmQueue, playNcmIdx, cyclePlayMode, playMode, loved, setLoved, cur, addToLib }) {
  ...
  vUseEffect(() => {
    ...
    st.textContent = [
      ...
      ".lsr-ava{width:42px;height:42px;border-radius:50%;overflow:hidden;flex-shrink:0;background:var(--ls-panel2);border:1px solid var(--ls-line-soft)}",
      ...
      ".lsr-row.self .lsr-bubble{background:var(--lsr-bub-self,color-mix(in srgb, var(--ls-gold) 22%, var(--ls-panel)));color:var(--ls-ink);border:1px solid color-mix(in srgb, var(--ls-gold) 35%, transparent);border-bottom-right-radius:6px;backdrop-filter:blur(var(--lsr-blur-self,0px));-webkit-backdrop-filter:blur(var(--lsr-blur-self,0px))}",
      ".lsr-row.other .lsr-bubble{background:var(--lsr-bub-other,var(--ls-panel2));color:var(--ls-ink);border:1px solid var(--ls-line-soft);border-bottom-left-radius:6px;backdrop-filter:blur(var(--lsr-blur-other,10px));-webkit-backdrop-filter:blur(var(--lsr-blur-other,10px))}",
